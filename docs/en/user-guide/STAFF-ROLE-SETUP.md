...
- administrators and editors now have full access to the Event Tickets plugin admin area
- use the Staff role only for operational users who should not receive the full plugin workspace
