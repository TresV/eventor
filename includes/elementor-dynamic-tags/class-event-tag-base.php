...
/**
 * Base helper for Event dynamic tags.
 */
abstract class Event_Tag_Base extends Tag
{
    ...
    protected function get_event_id(): int
    {
        ...
        if ('specific' === $source) {
            ...
            if (! $event_id && isset($_GET['evt_event_id'])) {
                $event_id = absint(wp_unslash($_GET['evt_event_id']));
            }
