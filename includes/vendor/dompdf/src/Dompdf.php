...
class Dompdf
{
    ...
    */
    ...
    public function __construct($options = null)
    {
        ...
        if ($versionFile && ($version = file_get_contents($versionFile)) !== false) {
    ...
    public function loadHtml($str, $encoding = null)
    {
        ...
        try {
            ...
            // dompdf upstream typically uses Masterminds/html5-php for parsing.
            // In environments where it's not bundled, fall back to DOMDocument.
